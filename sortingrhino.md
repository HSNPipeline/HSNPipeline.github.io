...
This template assumes you have access to a Windows or Apple computer.
Their operating systems interact differently with Rhino.
This is especially important for the manual selection step.
...
We **strongly** suggest that cloning the HSNPipeline combinato
[fork](https://github.com/HSNPipeline/combinato) instead of the original repo:
`git clone https://github.com/HSNPipeline/combinato.git`
...
1. Install XQuartz 2.8.0 / 2.8.1 on your mac
...
Once more, a Windows and a Mac will need different strategies.
